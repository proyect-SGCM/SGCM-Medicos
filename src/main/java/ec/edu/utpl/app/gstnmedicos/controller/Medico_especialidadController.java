...
import ec.edu.utpl.app.gstnmedicos.models.services.IMedico_especialidadService;
...
public class Medico_especialidadController {
	...
	public Medicos_especialidad crearMedicoEspecialidad(@RequestBody Medicos_especialidad medico_especialidad) {
	...
	public List<Medicos_especialidad> listarMedicoEspecialidad() {
	...
	public ResponseEntity<?> verMedicoEspecialidad(@PathVariable Long id) {
		...
		Medicos_especialidad medico_especialidad = null;
		...
		return new ResponseEntity<Medicos_especialidad>(medico_especialidad, HttpStatus.OK);
	}
	...
	@ResponseStatus(HttpStatus.CREATED)
	public Medicos_especialidad editarMedicoEspecialidad(@RequestBody Medicos_especialidad medico_especialidad,
			@PathVariable Long id) {

		Medicos_especialidad medico_especialidadActual = medico_especialidadService.findById(id);
